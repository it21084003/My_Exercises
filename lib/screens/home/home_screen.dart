...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _showManageCategoriesDialog(bool isDarkMode) {
    ...
    List<String> selectedCategories =
        List.from(_categories); // Store selected categories
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: CupertinoButton(
                      ...
                      color: isDarkMode
                          ? const Color(
                              0xFF9B51E0) // 🔥 Beautiful Dark Mode Purple
                          : const Color.fromARGB(255, 163, 95,
                              163), // 🎨 Light Lavender in Light Mode
                    ...
                    children: exerciseCategories.map((category) {
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(16),
                          border: Border.all(
                              color: Colors.blue, width: 1), // Thin blue border
                        ),
                        child: Text(
                          category,
