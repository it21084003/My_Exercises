...
import 'result_page_online.dart';

class ExercisePageOnline extends StatefulWidget {
  final String exerciseNumber;

  const ExercisePageOnline({super.key, required this.exerciseNumber});

  @override
  State<ExercisePageOnline> createState() => _ExercisePageOnlineState();
}

class _ExercisePageOnlineState extends State<ExercisePageOnline> with AutomaticKeepAliveClientMixin {
    ...
    _questionsFuture.then((questions) {
      if (_isMounted && mounted) {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => ResultPageOnline(
              questions: questions,
